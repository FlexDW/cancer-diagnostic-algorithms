# Saves:
# - "Diagrams/compare_ROC_PCUR_iso_vs_mir.png"
...
# create plot
png(filename="Diagrams/compare_ROC_PCUR_iso_vs_mir.png", width=800, height=400)
par(mfrow=c(1, 2))
plot(roc1.ridge, type='l', col=cols["isomirs"], 
     main="ROC comparison, urine data  (no selection)",
     cex.main=0.9)
...
plot(roc1.EN, type='l', col=cols["isomirs"], 
     main="ROC comparison, urine data  (5 variables)",
     cex.main=0.9)
