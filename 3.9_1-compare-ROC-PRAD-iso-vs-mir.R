...
# Saves:
# - "Diagrams/compare_ROC_PRAD_iso_vs_mir.png"
...
# create plot
png(filename="Diagrams/compare_ROC_PRAD_iso_vs_mir.png", width=800, height=400)
par(mfrow=c(1, 2))
plot(roc1.ridge, type='l', col=cols["isomirs"], 
     main="ROC comparison, tissue data  (no selection)",
     cex.main=0.9)
...
plot(roc1.EN, type='l', col=cols["isomirs"], 
     main="ROC comparison, tissue data  (5 variables)",
     cex.main=0.9)
