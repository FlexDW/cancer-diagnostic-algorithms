...
# File: 4.1a-plot-PCA-in-two-dimensions-PRAD-mir.R
...
#### Plot PCAs ####
png(filename="Diagrams/PCA-in-two-dimensions-PRAD-mir.png", width=400, height=400) 
plot(pc, #cex.main=0.8, cex.lab=0.7,
     ...
     pch=20,
     main="PCA - MicroRNA, tissue dataset")
