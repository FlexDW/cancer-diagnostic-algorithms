...
#### Plot PCAs ####
png(filename="Diagrams/PCA-in-two-dimensions-PCBL-isomir.png", width=400, height=400) 
plot(pc, #cex.main=0.8, cex.lab=0.7,
     xlab=paste("PC1 (VAF=", VAF1, ")", sep=""), 
     ylab=paste("PC2 (VAF=", VAF2, ")", sep=""), 
     col=(as.numeric(!PCBL$ctrlIndex)+1), # red=tumor, black=healthy
     pch=20,
     main="Principal Components Analysis, blood dataset")
